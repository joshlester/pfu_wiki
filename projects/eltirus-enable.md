...
2. Update .env file to point to Production.

2. Copy the production files to a new build directory e.g. 0.3.2 on the server
```
rsync -avzP -e "ssh -i ~/.ssh/eltirus_enable_vm_01.prv" build public prisma remix.config.js index.js .env package.json eltirus_enable_01@20.211.108.35:/srv/www/eltirus_enable/0.1.0
```
...
### Deploy env files
```
rsync -avzP -e "ssh -i /home/josh/.ssh/eltirus_enable/eltirus_enable_vm_01.prv" .env ecosystem.config.js  container eltirus_enable_01@20.211.108.35:/srv/www/eltirus_enable
```
